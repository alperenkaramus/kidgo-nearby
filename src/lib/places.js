...
function toUiPlace(place) {
  ...
  return {
    ...
    distanceLabel: typeof place.distanceKm === 'number' ? `${place.distanceKm} km` : 'City pick / şehir önerisi',
    score,
    lat: place.lat,
    lon: place.lon,
    address: place.address || 'Location check recommended / haritada kontrol et',
